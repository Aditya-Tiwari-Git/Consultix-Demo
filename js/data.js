...
const CATEGORIES = {
    'Cards': ['Debit Card Blocked', 'Credit Card Issue', 'Card Activation', 'Lost/Stolen Card'],
    'Account': ['Balance Inquiry', 'Account Locked', 'Transaction Dispute', 'Statement Request'],
    'Loans': ['Loan Application', 'EMI Issue', 'Loan Closure', 'Interest Rate Query'],
    'Digital Banking': ['Mobile App Issue', 'Internet Banking', 'UPI Problem', 'Password Reset'],
    'General': ['Branch Services', 'Feedback', 'Complaint', 'Other']
};

// Knowledge Base / Common Issues for Search Suggestions
const KNOWLEDGE_BASE = [
    { title: 'How to unblock debit card', category: 'Cards', keywords: ['debit', 'block', 'card', 'atm'] },
    { title: 'Reset internet banking password', category: 'Digital Banking', keywords: ['password', 'reset', 'internet', 'banking', 'login'] },
    { title: 'Check account balance', category: 'Account', keywords: ['balance', 'account', 'check', 'inquiry'] },
    { title: 'Report lost or stolen card', category: 'Cards', keywords: ['lost', 'stolen', 'card', 'report'] },
    { title: 'UPI transaction failed', category: 'Digital Banking', keywords: ['upi', 'transaction', 'failed', 'payment'] },
    { title: 'Loan EMI payment issue', category: 'Loans', keywords: ['loan', 'emi', 'payment', 'issue'] },
    { title: 'Mobile app not working', category: 'Digital Banking', keywords: ['mobile', 'app', 'not working', 'crash'] },
    { title: 'Transaction dispute resolution', category: 'Account', keywords: ['transaction', 'dispute', 'wrong', 'charge'] }
];
...
const INITIAL_TICKETS = [
    {
        ...
        detailedDescription: 'My debit card is blocked after 3 wrong PIN attempts. Need urgent help to unblock.',
        priority: 'High',
        impact: 'High',
        urgency: 'High',
    ...
    },
    {
        ...
        detailedDescription: 'Getting error message when trying to login to internet banking portal.',
        priority: 'Medium',
        impact: 'Medium',
        urgency: 'Medium',
